                    ...
                    <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                @if ($post->image)
                                    <img src="{{ asset('storage/' . $post->image) }}" class="mt-2 mb-2 w-full max-w-xs rounded-md" alt="Thumbnail lama">
                                @else
                                    <p class="mt-2 text-sm text-gray-500">Tidak ada gambar thumbnail sebelumnya.</p>
                                @endif
                            ...
                            <div>
                                ...
                                <textarea name="content" id="content" rows="10" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm tinymce-editor">{{ old('content', $post->content) }}</textarea>
                            </div>
